...
csv_file_paths = {
    'stocks':  r'ProjectAIML_Stock/Combined_Data.csv',
    'volatile_stocks': r'ProjectAIML_Stock/Top_10_Vol_Stocks.csv',
    'top_performing_stocks': r'ProjectAIML_Stock/Top_5_stocks.csv',
    'sector_performance':  r'ProjectAIML_Stock/SectorWisePerformance.csv',
    'correlation_matrix': r'ProjectAIML_Stock/Correlation_Matrix.csv',
    'top_gainers_losers': r'ProjectAIML_Stock/Top_Gainers_Losers_Monthwise.csv',
    'green_red_stocks': r'ProjectAIML_Stock/TopGainNLoss_Data.csv',
    'market_summary' : r"ProjectAIML_Stock/MarketSummary.csv"
}
...
def market_summary():
    ...
    df = pd.read_csv(r"ProjectAIML_Stock/MarketSummary.csv")
...
def top_5_performing_stocks():
    ...
    df = pd.read_csv(r'ProjectAIML_Stock/Top_5_stocks.csv')
...
def top_10_green_red_stocks():
    green_df = pd.read_csv(r"ProjectAIML_Stock/Top_10_Green_Stocks.csv")
    red_df = pd.read_csv(r"ProjectAIML_Stock/Top_10_Red_Stocks.csv")
